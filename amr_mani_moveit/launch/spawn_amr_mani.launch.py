...
def generate_launch_description():
    moveit_config_folder_name = 'amr_mani_moveit'

    xacro_file = get_package_file(moveit_config_folder_name, 'config/amr_mani.urdf.xacro')
    urdf_file = run_xacro(xacro_file)
    robot_description_arm = load_file(urdf_file)

    srdf_file = get_package_file(moveit_config_folder_name, 'config/amr_mani.srdf')
